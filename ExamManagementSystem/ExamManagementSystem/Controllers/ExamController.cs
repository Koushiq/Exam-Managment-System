...
namespace ExamManagementSystem.Controllers
{
    public class ExamController : Controller
    {
        ...
        private string GeneratePDF(int eid)
        {
            ...
            string pdfFolder = @"C:\Users\koush\OneDrive\Desktop\proj\Exam-Managment-System\ExamManagementSystem\ExamManagementSystem\PDFs\" + uid + "-" + eid + ".pdf";
